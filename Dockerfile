...
RUN apk add gcc python3-dev musl-dev linux-headers git
...
RUN pip3 install -i https://test.pypi.org/simple/ pmoired==1.2
# -- github.com/amerand/PMOIRED_examples
#ADD . /PMOIRED_examples
RUN git clone https://github.com/amerand/PMOIRED_examples
